...
const DND_DRAGGABLE_DATA_ATTR = '[data-react-beautiful-dnd-draggable]';

const mockDndElSpacing = rtlUtils => {
...
const DND_DIRECTION_LEFT = 'DND_DIRECTION_LEFT';
const DND_DIRECTION_UP = 'DND_DIRECTION_UP';
const DND_DIRECTION_RIGHT = 'DND_DIRECTION_RIGHT';
const DND_DIRECTION_DOWN = 'DND_DIRECTION_DOWN';
...
const makeDnd = async ({
  ...
  const handleMovementInDirection = async () => {
    ...
    react.fireEvent.keyDown(getDragEl(), spaceKey);
    await react.waitForElement(() => getByText(/You have lifted an item/i));
    // move drag element based on direction
    react.fireEvent.keyDown(getDragEl(), getKeyForDirection());
    await react.waitForElement(() => getByText(/You have moved the item/i));
    // disable keyboard dragging
    react.fireEvent.keyDown(getDragEl(), spaceKey);
    await react.waitForElement(() => getByText(/You have dropped the item/i));
  };
...
exports.DND_DIRECTION_LEFT = DND_DIRECTION_LEFT;
exports.DND_DIRECTION_RIGHT = DND_DIRECTION_RIGHT;
exports.DND_DIRECTION_UP = DND_DIRECTION_UP;
exports.DND_DRAGGABLE_DATA_ATTR = DND_DRAGGABLE_DATA_ATTR;
exports.makeDnd = makeDnd;
exports.mockDndElSpacing = mockDndElSpacing;
exports.mockGetComputedSpacing = mockGetComputedSpacing;
